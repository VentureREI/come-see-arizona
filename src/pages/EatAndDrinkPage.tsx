...
const PHOENIX_RESTAURANTS = [
  ...
  { name: "The Gladly", location: "Camelback Corridor", description: "Contemporary American cuisine with a focus on seasonal ingredients in a polished but approachable setting.", image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=800&q=80" },
...
const SCOTTSDALE_RESTAURANTS = [
  { name: "Cafe Monarch", location: "Old Town Scottsdale", description: "A small, prix-fixe restaurant that consistently ranks among the top fine dining experiences in the state with intimate 30-seat dining.", image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=800&q=80" },
...
const FINE_DINING = [
  ...
  { name: "Cafe Monarch", location: "Old Town Scottsdale", description: "A four-course prix-fixe experience in an intimate, 30-seat dining room that consistently ranks among the state's best.", image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=800&q=80" },
...
const ROOFTOP_BARS = [
  ...
  { name: "Floor 13 Rooftop Bar", location: "Hotel San Carlos, Downtown", description: "Panoramic views of downtown Phoenix from the historic Hotel San Carlos, with craft cocktails and small plates.", image: "https://images.unsplash.com/photo-1470337458703-46ad1756a187?auto=format&fit=crop&w=800&q=80" },
